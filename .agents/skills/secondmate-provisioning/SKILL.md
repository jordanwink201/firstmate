...
Propagation failures warn without blocking secondmate launch or session-start continuation, except a present primary `config/git-author` that cannot converge blocks secondmate launch and makes focused config push fail non-zero.
