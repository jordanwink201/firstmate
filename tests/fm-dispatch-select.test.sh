...
# The selector under test needs the real jq; make it resolvable regardless of
# where it is installed (Homebrew, Nix profile bins, etc.), which the bare
# BASE_PATH above does not cover.
