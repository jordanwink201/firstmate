...
config/git-author  optional crewmate commit identity; LOCAL, gitignored; name=... and email=... pin worktree Git config plus GIT_AUTHOR_*/GIT_COMMITTER_* for spawned agents and inherited secondmate homes
