...
config/git-author  optional crewmate commit identity; LOCAL, gitignored; see docs/configuration.md "Crewmate Git author identity"
...
state/               volatile runtime signals; gitignored
  ...
  <id>.meta          task metadata; fm-spawn's base fields are owned by bin/fm-spawn.sh; runtime backend additions are owned by docs/configuration.md "Runtime backend" and bin/fm-backend.sh; PR/MR and X-mode helpers append their fields under their own docs and sections
