...
| `fm-bearings-snapshot.sh` | Project the fleet snapshot to compact bearings or advisory views; default local-only |
| `fm-update.sh`           | Fast-forward-only self-update of firstmate and secondmate homes from origin          |
| `fm-backlog-handoff.sh`  | Validate and delegate queued backlog-item moves into a secondmate home               |
| `fm-brief.sh`            | Scaffold ship, scout, secondmate-charter, and Herdr-lab briefs                       |
| `fm-browser-qa.sh`       | Attach to authenticated Chrome, prove one exact QA URL, and write browser evidence   |
...
| `fm-github-pretool-check.sh` | Stable PreToolUse transport for fork/upstream GitHub mutation policy (docs/github-fork-guard.md) |
| `fm-github-command-policy.mjs` | Semantic owner of the fork/upstream GitHub mutation policy (docs/github-fork-guard.md) |
...
| `fm-classify-lib.sh`     | Shared wake classification vocabulary and launch-watchdog predicates                 |
