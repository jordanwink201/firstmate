...
# The captain-relevant verb set, launch-watchdog predicates, and status
# classifiers (last_status_line, status_is_captain_relevant, window_to_task,
# scan_captain_relevant_statuses) live in bin/fm-classify-lib.sh, shared with the
# always-on watcher.
